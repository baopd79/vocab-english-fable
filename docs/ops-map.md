...
# Quên/đổi mật khẩu basic-auth của /admin (v1.1 A3) — openssl hỏi mật khẩu, không lộ vào history:
printf 'baobun:%s\n' "$(openssl passwd -apr1)" > ~/vocab-english-fable/nginx/htpasswd && $C restart nginx
```
